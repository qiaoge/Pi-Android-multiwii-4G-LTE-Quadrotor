 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_DELAY     500                     // Guard time for failsafe activation after signal lost. 1 step = 0.1sec - 1sec in example
  ...
  /**************************************************************************************/
    ...
    #define GPS_BAUD   115200//57600       // GPS_BAUD will override SERIALx_COM_SPEED for the selected port
...
#define MAG_DECLINATION  -2.67f   //(**)  foshan -2d44m
