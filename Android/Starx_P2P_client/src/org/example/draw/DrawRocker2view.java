...
public class DrawRocker2view extends SurfaceView implements SurfaceHolder.Callback,Runnable{
	private Thread th;
	...
	public DrawRocker2view(Context context, AttributeSet attrs) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		if(!stop){
			...
			ControlData.control_turn_left_right=
